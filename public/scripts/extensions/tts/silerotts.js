...
class SileroTtsProvider {
    ...
    get settingsHtml() {
        ...
        <span>
        <span>Use <a target="_blank" href="https://github.com/SillyTavern/SillyTavern-extras">MYnestAI Extras API</a> or <a target="_blank" href="https://github.com/ouoertheo/silero-api-server">Silero TTS Server</a>.</span>
        `;
        return html;
    }
